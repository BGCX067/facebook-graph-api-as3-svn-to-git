...
package com.facebook.graph.enum 
{
	...
	public class FacebookScopeType 
	{
		...
		/// Provides access to education history as the education property		public static const USER_EDICATION_HISTORY : String = "user_education_history";		public static const FRIENDS_EDICATION_HISTORY : String = "friends_education_history";
